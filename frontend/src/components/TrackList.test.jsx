...
function buildDefaultTracklistContext(overrides = {}) {
  return {
...
function renderTrackList({ tracklist = [], shellOverrides = {}, tracklistOverrides = {} } = {}) {
  const tracklistCtx = buildDefaultTracklistContext(tracklistOverrides);
  const shellValue = { detailData: { tracklist }, ...shellOverrides };
  render(
