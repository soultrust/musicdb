  ...
  if (!accessToken) {
    return (
      <AuthGate
        ...
        onChangeEmail={(e: ChangeEvent<HTMLInputElement>) => setAuthEmail(e.target.value)}
        onChangePassword={(e: ChangeEvent<HTMLInputElement>) => setAuthPassword(e.target.value)}
        onToggleAuthMode={() => {
